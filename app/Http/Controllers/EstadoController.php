...
class EstadoController extends Controller
{
    ...
    {
        $request->validate([
            'nombre' => 'required|string|max:50|'.UnifiedValidation::uniqueTransparencia('estados', 'nombre'),
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'nombre' => 'required|string|max:50|'.UnifiedValidation::uniqueTransparencia('estados', 'nombre', $estado->estadoid, 'estadoid'),
            'descripcion' => 'nullable|string|max:255',
        ], [
            'nombre.unique' => 'Ya existe un estado con ese nombre.',
        ]);
