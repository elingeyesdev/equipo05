...
class AccessControl
{
    ...
    public static function rolePermissionMap(): array
    {
        return [
            ...
            'Almacenero' => [
                'inventario.dashboard.ver', 'inventario.categorias.gestionar',
                'inventario.productos.gestionar', 'inventario.donaciones.registrar',
                'inventario.almacenes.gestionar', 'inventario.stock.gestionar',
                'inventario.paquetes.gestionar', 'inventario.salidas.registrar',
                'inventario.reportes.ver',
                'incendios.dashboard.ver',
