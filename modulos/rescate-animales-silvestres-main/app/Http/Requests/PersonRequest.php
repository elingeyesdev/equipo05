...
class PersonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
			...
			'ci' => 'required|string|unique:rescate.people,ci' . ($personId ? ',' . $personId : ''),
			'telefono' => 'nullable|string',
			'es_cuidador' => 'nullable|boolean',
			'cuidador_center_id' => 'nullable|exists:rescate.centers,id',
        ...
        if ($this->boolean('es_cuidador')) {
            $rules['cuidador_center_id'] = 'required|exists:rescate.centers,id';
