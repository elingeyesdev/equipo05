...
@section('title', 'Dashboard Voluntario — Inventario')
@section('subtitle', 'Recepción de donaciones y apoyo en campo.')

@section('content_header')
<div class="d-flex flex-wrap justify-content-between align-items-center">
    <div>
        <h1 class="m-0"><i class="fas fa-hands-helping text-primary"></i> Dashboard de donaciones</h1>
        <p class="text-muted mb-0 small">Vista del voluntario</p>
    </div>
</div>
@endsection
