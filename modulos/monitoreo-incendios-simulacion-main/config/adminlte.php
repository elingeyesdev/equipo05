    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Actividad de Incendios',
                    'url' => '/reports/fires',
                    'icon' => 'fas fa-fire text-danger',
                ],
                [
                    'text' => 'Gestión de Biomasas',
                    'url' => '/reports/biomasas',
                    'icon' => 'fas fa-leaf text-success',
                ],
                [
                    'text' => 'Efectividad de Simulaciones',
                    'url' => '/reports/simulations',
        ...
        'CustomUserMenu' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/custom-user-menu.css',
                ],
            ],
        ],
        'Datatables' => [
