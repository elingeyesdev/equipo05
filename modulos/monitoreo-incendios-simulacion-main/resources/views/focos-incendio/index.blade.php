...
@section('content_header_subtitle', 'Listado operativo')

@section('css')
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" />
<style>
    #mapModal .modal-dialog { max-width: 90%; }
    #addFireMap { height: 600px; width: 100%; }
    .fire-marker { background: transparent !important; border: none !important; }
    .pagination { display: inline-flex; flex-wrap: wrap; justify-content: center; gap: 4px; }
</style>
@endsection
        ...
        <div class="card-header">
            <div class="inc-btn-toolbar w-100">
                <button type="button" class="btn btn-outline-secondary btn-sm"
                    ...
                    <i class="fas fa-satellite"></i> NASA FIRMS
                </button>
                <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal" data-target="#mapModal"
                        title="Agregar focos marcándolos en el mapa">
                    <i class="fas fa-map-marked-alt"></i> Desde mapa
                </button>
                <a href="{{ route('incendios.focos-incendios.create') }}" class="btn btn-danger btn-sm">
                    <i class="fas fa-plus"></i> Nuevo foco
                </a>
            </div>
        </div>
                ...
                <table class="table table-hover inc-data-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>Ubicación</th>
                            <th>Coordenadas</th>
                            <th style="width: 6rem;">Intensidad</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="inc-row-actions">
                                        <a href="{{ route('incendios.focos-incendios.show', $focosIncendio->id) }}" class="btn btn-outline-primary btn-sm" title="Ver">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('incendios.focos-incendios.edit', $focosIncendio->id) }}" class="btn btn-outline-secondary btn-sm" title="Editar">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('incendios.focos-incendios.destroy', $focosIncendio->id) }}" method="POST" class="d-inline"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fas fa-map-marked-alt text-primary"></i> Agregar focos desde mapa
                    </h5>
