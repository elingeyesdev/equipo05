...
<li class="nav-item dropdown user-menu">
    ...
    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-footer">
            ...
            <div class="row mb-2">
                <div class="col-12 text-center">
                    <small class="text-muted">
                        <i class="fas fa-envelope mr-1"></i><?php echo e(Auth::user()->email); ?>
                ...
                <div class="col-12 text-center mt-1">
                    <small class="text-muted">
                        <i class="fas fa-phone mr-1"></i><?php echo e(Auth::user()->telefono); ?>
            ...
            <?php endif; ?>
            <a class="btn btn-danger btn-flat float-right <?php if(!$profile_url): ?> btn-block <?php endif; ?>"
